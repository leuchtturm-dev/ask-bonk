/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d58e48944435c2481b4b94e308948a16)
...
interface __BaseEnv_Env {
	...
	BONK_VERSION: "dev";
	BONK_COMMIT: "unknown";
	ALLOWED_ORGS: ["elithrar","cloudflare","ask-bonk","replicate","emdash-cms","Cloudflare-Studio"];
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "RepoAgent" | "Sandbox" | "FlueRegistry" | "FlueControlPlaneAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEFAULT_MODEL" | "BONK_VERSION" | "BONK_COMMIT" | "ALLOWED_ORGS">> {}
}
declare module "*.hbs" {
	const value: string;
